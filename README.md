...
| Keep actions and npm packages current | [Dependabot config]([dependabot/dependabot.yml](https://github.com/Felipemguerra/configs/blob/master/dependabot/dependabot.yml)) | `.github/dependabot.yml` |
